...
//let t1 = 0;
     ...
     var c = document.getElementById("canvas");
        ...
        speedGradient.addColorStop(0, '#3eb149');
        speedGradient.addColorStop(1, '#A7D274');
        ...
        function drawMiniNeedle(rotation, width, speed) {
            ...
            ctx.font = "700 20px Titillium Web";
        ...
        function drawSpeedo(speed, gear, rpm, topSpeed) {
            ...
            ctx.font = "700 70px Titillium Web";
            ctx.textAlign = "center";
            ctx.fillText(speed, 250, 220);

            ctx.font = "700 15px Titillium Web";
            ...
            if (gear == 0 && speed > 0) {
                ...
                ctx.fillStyle = "#333";
                ctx.font = "700 50px Titillium Web";
